...
def evaluate(actor_critic, ob_rms, env_name, seed, num_processes, eval_log_dir,
             device, num_episodes=None, atari_max_steps=None, fname=None):
    ...
    if fname is not None:
        print(f'Saving socres to {fname+"_tscr_det="+str(det)+".npy"}')
        np.save(fname +'_tscr_det='+str(det)+".npy", eval_episode_rewards)
